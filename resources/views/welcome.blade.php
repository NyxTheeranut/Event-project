            ...
            <div class="flex h-full items-center justify-left">
                <div class="max-w-[800px] px-6 py-6 text-left text-white md:py-0 md:px-12">
                    ...
                    <a href="{{ route('events.index') }}"
                       class="text-white text-xl bg-cyan-700 hover:bg-cyan-800 focus:ring-4 focus:ring-cyan-900 font-medium rounded-3xl text-sm px-9 lg:px-10 py-3 lg:py-3.5 sm:mr-2 lg:mr-0 focus:outline-none">Events</a>
                </div>
            </div>
        </div>
    </div>
